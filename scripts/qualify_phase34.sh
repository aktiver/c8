...
# Real-cluster qualification for direct fragment-spool partitioning. The supplied
...
jq -n \
  ...
  '{status: "phase34-direct-primary-partition-passed", exactIndependentBagEqual: true,
