...
class DifferentialCanonicalizationTests(unittest.TestCase):
    ...
    def test_every_graph_requires_pinned_canonicalizer(self) -> None:
        with self.assertRaisesRegex(RuntimeError, "pinned RDFC-1.0"):
            canonical_graph(b"<urn:s> <urn:p> <urn:o> .\n", None, None)
