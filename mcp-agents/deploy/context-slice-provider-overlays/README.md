...
The cluster/node autoscaler is intentionally external to this chart. Broker CPU and memory requests plus the `ngkg.io/workload-class=cpu-hpc` selector are the scheduling contract used by Karpenter, EKS/AKS/GKE Cluster Autoscaler, or separately qualified RKE/RKE2 node provisioning.
