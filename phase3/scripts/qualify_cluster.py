...
REQUIRED_PROVIDERS = {"rke", "rke2", "eks", "aks", "gke"}
...
class Qualification:
    ...
    def validate_configuration(self) -> None:
        ...
        require(self.image_lock.get("formatVersion") == 1 and len(self.image_lock.get("images", [])) == 13, "Phase 8 image lock is incomplete")
